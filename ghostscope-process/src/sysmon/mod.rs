...
#[cfg(feature = "sysmon-ebpf")]
const SYSMON_WORK_LIFECYCLE_QUEUE_CAPACITY: usize = 16_384;
#[cfg(feature = "sysmon-ebpf")]
const SYSMON_WORK_LIFECYCLE_PROCESS_LIMIT: usize = 64;
#[cfg(feature = "sysmon-ebpf")]
const SYSMON_WORK_LIFECYCLE_TIME_BUDGET: Duration = Duration::from_millis(5);
#[cfg(feature = "sysmon-ebpf")]
