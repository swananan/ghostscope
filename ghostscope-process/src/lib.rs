...
pub use pid::{
    ...
    resolve_proc_pid_for_event, PidAttachRequest, PidFilterSpec, PidModeFailFast, PidNamespaceId,
    PidResolveSource, PidViews, ResolvePidSessionError, ResolvedPidSession, RuntimeEnvironment,
